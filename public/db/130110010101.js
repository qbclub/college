export default {
  ...
  test: {
    questions: [
      ...
      },
      {
        ...
        answers: [
          {
            text: "Проводник (электрический проводник) — это вещество, которое отлично проводит электрический ток, так как имеет в своем составе множество свободных {}.",
            answer: "электронов",
          },
        ]
      },
      {
        ...
        answers: [
          {
            text: "Полупроводники – это вещества, находящиеся по своей удельной {}  между проводниками и диэлектриками.",
            answer: "проводимости",
          },
        ]
      },
      {
        question: "Установите последовательность операций при пайке проводов",
        type: "sort",
        answers: [
          {
            text: ['Плотно скрутить жилы', 'Пропаять место соединения паяльником','Снять изоляцию с токопроводящих жил', 'Место пайки обернуть изоляционной лентой'],
            answer: ['Снять изоляцию с токопроводящих жил', 'Плотно скрутить жилы', 'Пропаять место соединения паяльником','Место пайки обернуть изоляционной лентой'],
          },
        ]
      },
      {
        question: "Установите порядок расположения проводниковых материалов от наименьшего значения удельного сопротивления проводника к наибольшему.",
        type: "sort",
        answers: [
          {
            text: ['Медь', 'Алюминий','Серебро', 'Нихром'],
            answer: ['Серебро', 'Медь', 'Алюминий','Нихром'],
          },
        ]
      },
      {
  ...
  quiz: {
    questions: [
      ...
      {
        question: 'Установите соответствие между цветом окрашиваемых проводников для их идентификации',
        type: 'sort',
        image: '',
        answers: [
          {
            text: ["Фазный проводник трехфазной цепи – L2", "Фазный проводник трехфазной цепи – L3","Фазный проводник трехфазной цепи – L1",  "Нейтральный проводник - N"],
            answer: ["Фазный проводник трехфазной цепи – L1", "Фазный проводник трехфазной цепи – L2", "Фазный проводник трехфазной цепи – L3", "Нейтральный проводник - N"],
            images: ["../assets/images/sort1_1.png", "../assets/images/sort1_2.png", "../assets/images/sort1_3.png", "../assets/images/sort1_4.png"]
          }
        ]
      },
      {
        question: 'Установите соответствие между маркой кабеля его внешним видом',
        type: 'sort',
        image: '',
        answers: [
          {
            text:  ["Кабель ВВГ-Пнг(А)-LS 3х6", "Кабель ААБл 3х120", "Кабель ВВГЭнг(A)-LS 3х6","Кабель АВБШв нг(А) 3x6", ],
            answer: ["Кабель ВВГ-Пнг(А)-LS 3х6", "Кабель АВБШв нг(А) 3x6", "Кабель ААБл 3х120", "Кабель ВВГЭнг(A)-LS 3х6"],
